@php
    $restaurantName = \App\Models\Setting::first()?->restaurant_name ?? 'The Grill House';
@endphp
...
<header class="sticky top-0 z-30 bg-background border-b border-border px-6 py-4 flex items-center justify-between transition-all duration-300">
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-[10px] text-muted-foreground uppercase tracking-[0.15em] font-bold mt-1.5 opacity-80">Terminal 04</p>
        </div>
    </div>
