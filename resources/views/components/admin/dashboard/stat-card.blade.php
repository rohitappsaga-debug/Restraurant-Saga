...
<div class="bg-card rounded-2xl p-6 border border-border shadow-sm transition-all hover:shadow-md hover:border-primary/20 group">
    <div class="flex items-center justify-between mb-4">
        ...
        @if($trend)
            <div class="flex items-center gap-1.5 px-2 py-1 rounded-full bg-emerald-500/10 text-emerald-500 text-[10px] font-extrabold uppercase tracking-wider">
    ...
    <div>
        <h3 class="text-xs font-bold text-muted-foreground uppercase tracking-widest mb-1 opacity-70">{{ $label }}</h3>
