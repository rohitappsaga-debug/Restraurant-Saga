<div class="space-y-10 pb-12 relative min-h-screen">
    ...
    <div wire:poll.10s>
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="{{ route('admin.orders') }}" wire:navigate class="text-[11px] font-black text-primary hover:bg-primary hover:text-white flex items-center gap-1.5 transition-all group uppercase tracking-[0.2em] bg-primary/10 px-4 py-2 rounded-xl">
                View All
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            @empty
                <div class="col-span-full py-20 flex flex-col items-center justify-center bg-card rounded-[2rem] border-2 border-dashed border-border opacity-60">
